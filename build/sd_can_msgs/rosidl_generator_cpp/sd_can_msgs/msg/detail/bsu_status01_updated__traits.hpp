...
#ifndef SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01_UPDATED__TRAITS_HPP_
#define SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01_UPDATED__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "bsu_switch_off_req: ";
    rosidl_generator_traits::value_to_yaml(msg.bsu_switch_off_req, out);
    out << ", ";
  }

  // member: bsu_limp_mode_activated
  {
    out << "bsu_limp_mode_activated: ";
    rosidl_generator_traits::value_to_yaml(msg.bsu_limp_mode_activated, out);
    out << ", ";
  }
...
inline std::string to_yaml(const BSUStatus01Updated & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sd_can_msgs::msg::BSUStatus01Updated & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sd_can_msgs::msg::BSUStatus01Updated & msg)
{
  return sd_can_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sd_can_msgs::msg::BSUStatus01Updated>()
{
  return "sd_can_msgs::msg::BSUStatus01Updated";
}

template<>
inline const char * name<sd_can_msgs::msg::BSUStatus01Updated>()
{
  return "sd_can_msgs/msg/BSUStatus01Updated";
}

template<>
struct has_fixed_size<sd_can_msgs::msg::BSUStatus01Updated>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sd_can_msgs::msg::BSUStatus01Updated>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sd_can_msgs::msg::BSUStatus01Updated>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01_UPDATED__TRAITS_HPP_
