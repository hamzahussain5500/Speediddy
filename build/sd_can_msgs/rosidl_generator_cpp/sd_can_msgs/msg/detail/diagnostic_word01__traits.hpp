...
#ifndef SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01__TRAITS_HPP_
#define SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "ecu_timeout_em_fault: ";
    rosidl_generator_traits::value_to_yaml(msg.ecu_timeout_em_fault, out);
    out << ", ";
  }

  // member: dem_cbafl_not_receive
  {
    out << "dem_cbafl_not_receive: ";
    rosidl_generator_traits::value_to_yaml(msg.dem_cbafl_not_receive, out);
    out << ", ";
  }
  ...
  {
    out << "dem_pdu12_v_not_receive: ";
    rosidl_generator_traits::value_to_yaml(msg.dem_pdu12_v_not_receive, out);
    out << ", ";
  }
  ...
  {
    out << "dem_cbafr_not_receive: ";
    rosidl_generator_traits::value_to_yaml(msg.dem_cbafr_not_receive, out);
    out << ", ";
  }
  ...
  {
    out << "pdu12_counter_error: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu12_counter_error, out);
    out << ", ";
  }

  // member: pdu12_timeout_error
  {
    out << "pdu12_timeout_error: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu12_timeout_error, out);
    out << ", ";
  }

  // member: pdu48_counter_error
  {
    out << "pdu48_counter_error: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu48_counter_error, out);
    out << ", ";
  }

  // member: pdu48_timeout_error
  {
    out << "pdu48_timeout_error: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu48_timeout_error, out);
    out << ", ";
  }

  // member: dem_cbarl_not_receive
  {
    out << "dem_cbarl_not_receive: ";
    rosidl_generator_traits::value_to_yaml(msg.dem_cbarl_not_receive, out);
    out << ", ";
  }
  ...
  {
    out << "dem_cbarr_not_receive: ";
    rosidl_generator_traits::value_to_yaml(msg.dem_cbarr_not_receive, out);
    out << ", ";
  }

  // member: em_stop_conditions_active
  {
    out << "em_stop_conditions_active: ";
    rosidl_generator_traits::value_to_yaml(msg.em_stop_conditions_active, out);
    out << ", ";
  }

  // member: ml_stop_conditions_active
  {
    out << "ml_stop_conditions_active: ";
    rosidl_generator_traits::value_to_yaml(msg.ml_stop_conditions_active, out);
    out << ", ";
  }

  // member: dcdc4812_under_min_start_limit
  {
    out << "dcdc4812_under_min_start_limit: ";
    rosidl_generator_traits::value_to_yaml(msg.dcdc4812_under_min_start_limit, out);
    out << ", ";
  }
  ...
  {
    out << "pdu12_active_anti_fire: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu12_active_anti_fire, out);
    out << ", ";
  }
  ...
  {
    out << "psa_steer_slip_warning: ";
    rosidl_generator_traits::value_to_yaml(msg.psa_steer_slip_warning, out);
    out << ", ";
  }

  // member: ice_error_legacy
  {
    out << "ice_error_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.ice_error_legacy, out);
    out << ", ";
  }

  // member: emb_line_press_over_max_start_limit_legacy
  {
    out << "emb_line_press_over_max_start_limit_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.emb_line_press_over_max_start_limit_legacy, out);
    out << ", ";
  }

  // member: pdu1_counter_error_legacy
  {
    out << "pdu1_counter_error_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu1_counter_error_legacy, out);
    out << ", ";
  }

  // member: pdu1_timeout_error_legacy
  {
    out << "pdu1_timeout_error_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu1_timeout_error_legacy, out);
    out << ", ";
  }

  // member: pdu2_counter_error_legacy
  {
    out << "pdu2_counter_error_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu2_counter_error_legacy, out);
    out << ", ";
  }

  // member: pdu2_timeout_error_legacy
  {
    out << "pdu2_timeout_error_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.pdu2_timeout_error_legacy, out);
    out << ", ";
  }

  // member: em_piston_hall_not_ready_legacy
  {
    out << "em_piston_hall_not_ready_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.em_piston_hall_not_ready_legacy, out);
    out << ", ";
  }

  // member: emb_tank_press_under_level1_legacy
  {
    out << "emb_tank_press_under_level1_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.emb_tank_press_under_level1_legacy, out);
    out << ", ";
  }

  // member: emb_tank_press_under_level2_legacy
  {
    out << "emb_tank_press_under_level2_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.emb_tank_press_under_level2_legacy, out);
    out << ", ";
  }

  // member: emb_tank_press_under_level3_legacy
  {
    out << "emb_tank_press_under_level3_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.emb_tank_press_under_level3_legacy, out);
    out << ", ";
  }

  // member: emb_tank_press_under_min_start_limit_legacy
  {
    out << "emb_tank_press_under_min_start_limit_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.emb_tank_press_under_min_start_limit_legacy, out);
    out << ", ";
  }

  // member: ice_over_rpm_warning_legacy
  {
    out << "ice_over_rpm_warning_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.ice_over_rpm_warning_legacy, out);
    out << ", ";
  }

  // member: ice_diagnostic_spare_legacy
  {
    out << "ice_diagnostic_spare_legacy: ";
    rosidl_generator_traits::value_to_yaml(msg.ice_diagnostic_spare_legacy, out);
  }
  out << "}";
...
inline std::string to_yaml(const DiagnosticWord01 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sd_can_msgs::msg::DiagnosticWord01 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sd_can_msgs::msg::DiagnosticWord01 & msg)
{
  return sd_can_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sd_can_msgs::msg::DiagnosticWord01>()
{
  return "sd_can_msgs::msg::DiagnosticWord01";
}

template<>
inline const char * name<sd_can_msgs::msg::DiagnosticWord01>()
{
  return "sd_can_msgs/msg/DiagnosticWord01";
}

template<>
struct has_fixed_size<sd_can_msgs::msg::DiagnosticWord01>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sd_can_msgs::msg::DiagnosticWord01>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sd_can_msgs::msg::DiagnosticWord01>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01__TRAITS_HPP_
