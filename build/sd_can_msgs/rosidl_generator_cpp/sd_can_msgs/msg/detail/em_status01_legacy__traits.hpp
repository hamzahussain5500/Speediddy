...
#ifndef SD_CAN_MSGS__MSG__DETAIL__EM_STATUS01_LEGACY__TRAITS_HPP_
#define SD_CAN_MSGS__MSG__DETAIL__EM_STATUS01_LEGACY__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "emb_line_pressure_bar: ";
    rosidl_generator_traits::value_to_yaml(msg.emb_line_pressure_bar, out);
    out << ", ";
  }

  // member: emb_tank_pressure_bar
  {
    out << "emb_tank_pressure_bar: ";
    rosidl_generator_traits::value_to_yaml(msg.emb_tank_pressure_bar, out);
    out << ", ";
  }
...
inline std::string to_yaml(const EMStatus01Legacy & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sd_can_msgs::msg::EMStatus01Legacy & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sd_can_msgs::msg::EMStatus01Legacy & msg)
{
  return sd_can_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sd_can_msgs::msg::EMStatus01Legacy>()
{
  return "sd_can_msgs::msg::EMStatus01Legacy";
}

template<>
inline const char * name<sd_can_msgs::msg::EMStatus01Legacy>()
{
  return "sd_can_msgs/msg/EMStatus01Legacy";
}

template<>
struct has_fixed_size<sd_can_msgs::msg::EMStatus01Legacy>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sd_can_msgs::msg::EMStatus01Legacy>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sd_can_msgs::msg::EMStatus01Legacy>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SD_CAN_MSGS__MSG__DETAIL__EM_STATUS01_LEGACY__TRAITS_HPP_
