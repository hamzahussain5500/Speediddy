...
#ifndef SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01_LEGACY__STRUCT_HPP_
#define SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01_LEGACY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Legacy __attribute__((deprecated))
#else
# define DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Legacy __declspec(deprecated)
#endif
...
struct DiagnosticWord01Legacy_
{
  using Type = DiagnosticWord01Legacy_<ContainerAllocator>;

  explicit DiagnosticWord01Legacy_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->emb_line_press_over_max_start_limit = 0;
      this->ice_oil_temp_under_min_start_limit = 0;
      this->pdu1_counter_error = 0;
      this->pdu1_timeout_error = 0;
      this->pdu2_counter_error = 0;
      this->pdu2_timeout_error = 0;
      this->em_piston_hall_not_ready = 0;
      this->psa_counter_error = 0;
      this->psa_derating = 0;
      this->psa_error = 0;
      this->psa_timeout_error = 0;
      this->emb_tank_press_under_level1 = 0;
      this->emb_tank_press_under_level2 = 0;
      this->emb_tank_press_under_level3 = 0;
      this->emb_tank_press_under_min_start_limit = 0;
      ...
      this->ice_diagnostic_spare = 0;
    }
  }

  explicit DiagnosticWord01Legacy_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  using _ice_error_type =
    uint8_t;
  _ice_error_type ice_error;
  ...
  using _emb_line_press_over_max_start_limit_type =
    uint8_t;
  _emb_line_press_over_max_start_limit_type emb_line_press_over_max_start_limit;
  ...
  using _pdu1_counter_error_type =
    uint8_t;
  _pdu1_counter_error_type pdu1_counter_error;
  using _pdu1_timeout_error_type =
    uint8_t;
  _pdu1_timeout_error_type pdu1_timeout_error;
  using _pdu2_counter_error_type =
    uint8_t;
  _pdu2_counter_error_type pdu2_counter_error;
  using _pdu2_timeout_error_type =
    uint8_t;
  _pdu2_timeout_error_type pdu2_timeout_error;
  using _em_piston_hall_not_ready_type =
    uint8_t;
  _em_piston_hall_not_ready_type em_piston_hall_not_ready;
  ...
  using _emb_tank_press_under_level1_type =
    uint8_t;
  _emb_tank_press_under_level1_type emb_tank_press_under_level1;
  using _emb_tank_press_under_level2_type =
    uint8_t;
  _emb_tank_press_under_level2_type emb_tank_press_under_level2;
  using _emb_tank_press_under_level3_type =
    uint8_t;
  _emb_tank_press_under_level3_type emb_tank_press_under_level3;
  using _emb_tank_press_under_min_start_limit_type =
    uint8_t;
  _emb_tank_press_under_min_start_limit_type emb_tank_press_under_min_start_limit;
  ...
  using _ice_over_rpm_warning_type =
    uint8_t;
  _ice_over_rpm_warning_type ice_over_rpm_warning;
  ...
  using _ice_diagnostic_spare_type =
    uint8_t;
  _ice_diagnostic_spare_type ice_diagnostic_spare;
  ...
  Type & set__emb_line_press_over_max_start_limit(
    const uint8_t & _arg)
  {
    this->emb_line_press_over_max_start_limit = _arg;
    return *this;
  }
  ...
  Type & set__pdu1_counter_error(
    const uint8_t & _arg)
  {
    this->pdu1_counter_error = _arg;
    return *this;
  }
  Type & set__pdu1_timeout_error(
    const uint8_t & _arg)
  {
    this->pdu1_timeout_error = _arg;
    return *this;
  }
  Type & set__pdu2_counter_error(
    const uint8_t & _arg)
  {
    this->pdu2_counter_error = _arg;
    return *this;
  }
  Type & set__pdu2_timeout_error(
    const uint8_t & _arg)
  {
    this->pdu2_timeout_error = _arg;
    return *this;
  }
  Type & set__em_piston_hall_not_ready(
    const uint8_t & _arg)
  {
    this->em_piston_hall_not_ready = _arg;
    return *this;
  }
  ...
  Type & set__emb_tank_press_under_level1(
    const uint8_t & _arg)
  {
    this->emb_tank_press_under_level1 = _arg;
    return *this;
  }
  Type & set__emb_tank_press_under_level2(
    const uint8_t & _arg)
  {
    this->emb_tank_press_under_level2 = _arg;
    return *this;
  }
  Type & set__emb_tank_press_under_level3(
    const uint8_t & _arg)
  {
    this->emb_tank_press_under_level3 = _arg;
    return *this;
  }
  Type & set__emb_tank_press_under_min_start_limit(
    const uint8_t & _arg)
  {
    this->emb_tank_press_under_min_start_limit = _arg;
    return *this;
  }
  ...
  Type & set__ice_over_rpm_warning(
    const uint8_t & _arg)
  {
    this->ice_over_rpm_warning = _arg;
    return *this;
  }
  ...
  Type & set__ice_diagnostic_spare(
    const uint8_t & _arg)
  {
    this->ice_diagnostic_spare = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator> *;
  using ConstRawPtr =
    const sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Legacy
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Legacy
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Legacy_<ContainerAllocator> const>
  ...
  bool operator==(const DiagnosticWord01Legacy_ & other) const
  {
    ...
    if (this->ice_error != other.ice_error) {
      return false;
    }
    ...
    if (this->emb_line_press_over_max_start_limit != other.emb_line_press_over_max_start_limit) {
      return false;
    }
    if (this->ice_oil_temp_under_min_start_limit != other.ice_oil_temp_under_min_start_limit) {
      return false;
    }
    if (this->pdu1_counter_error != other.pdu1_counter_error) {
      return false;
    }
    if (this->pdu1_timeout_error != other.pdu1_timeout_error) {
      return false;
    }
    if (this->pdu2_counter_error != other.pdu2_counter_error) {
      return false;
    }
    if (this->pdu2_timeout_error != other.pdu2_timeout_error) {
      return false;
    }
    if (this->em_piston_hall_not_ready != other.em_piston_hall_not_ready) {
      return false;
    }
    ...
    if (this->emb_tank_press_under_level1 != other.emb_tank_press_under_level1) {
      return false;
    }
    if (this->emb_tank_press_under_level2 != other.emb_tank_press_under_level2) {
      return false;
    }
    if (this->emb_tank_press_under_level3 != other.emb_tank_press_under_level3) {
      return false;
    }
    if (this->emb_tank_press_under_min_start_limit != other.emb_tank_press_under_min_start_limit) {
      return false;
    }
    ...
    if (this->ice_over_rpm_warning != other.ice_over_rpm_warning) {
      return false;
    }
    ...
    if (this->ice_diagnostic_spare != other.ice_diagnostic_spare) {
      return false;
    }
    return true;
  }
...
using DiagnosticWord01Legacy =
  sd_can_msgs::msg::DiagnosticWord01Legacy_<std::allocator<void>>;
...
#endif  // SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01_LEGACY__STRUCT_HPP_
