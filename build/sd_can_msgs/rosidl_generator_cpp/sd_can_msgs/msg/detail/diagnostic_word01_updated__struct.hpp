...
#ifndef SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01_UPDATED__STRUCT_HPP_
#define SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01_UPDATED__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Updated __attribute__((deprecated))
#else
# define DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Updated __declspec(deprecated)
#endif
...
struct DiagnosticWord01Updated_
{
  using Type = DiagnosticWord01Updated_<ContainerAllocator>;

  explicit DiagnosticWord01Updated_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit DiagnosticWord01Updated_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator> *;
  using ConstRawPtr =
    const sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Updated
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sd_can_msgs__msg__DiagnosticWord01Updated
    std::shared_ptr<sd_can_msgs::msg::DiagnosticWord01Updated_<ContainerAllocator> const>
  ...
  bool operator==(const DiagnosticWord01Updated_ & other) const
  {
...
using DiagnosticWord01Updated =
  sd_can_msgs::msg::DiagnosticWord01Updated_<std::allocator<void>>;
...
#endif  // SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01_UPDATED__STRUCT_HPP_
