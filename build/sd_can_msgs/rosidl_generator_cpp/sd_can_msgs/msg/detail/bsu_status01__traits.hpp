...
#ifndef SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01__TRAITS_HPP_
#define SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01__TRAITS_HPP_
...
inline std::string to_yaml(const BSUStatus01 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sd_can_msgs::msg::BSUStatus01 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sd_can_msgs::msg::BSUStatus01 & msg)
{
  return sd_can_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sd_can_msgs::msg::BSUStatus01>()
{
  return "sd_can_msgs::msg::BSUStatus01";
}

template<>
inline const char * name<sd_can_msgs::msg::BSUStatus01>()
{
  return "sd_can_msgs/msg/BSUStatus01";
}

template<>
struct has_fixed_size<sd_can_msgs::msg::BSUStatus01>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sd_can_msgs::msg::BSUStatus01>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sd_can_msgs::msg::BSUStatus01>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01__TRAITS_HPP_
