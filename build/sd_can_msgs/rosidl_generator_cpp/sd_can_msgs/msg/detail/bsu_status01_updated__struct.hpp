...
#ifndef SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01_UPDATED__STRUCT_HPP_
#define SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01_UPDATED__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sd_can_msgs__msg__BSUStatus01Updated __attribute__((deprecated))
#else
# define DEPRECATED__sd_can_msgs__msg__BSUStatus01Updated __declspec(deprecated)
#endif
...
struct BSUStatus01Updated_
{
  using Type = BSUStatus01Updated_<ContainerAllocator>;

  explicit BSUStatus01Updated_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit BSUStatus01Updated_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator> *;
  using ConstRawPtr =
    const sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sd_can_msgs__msg__BSUStatus01Updated
    std::shared_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sd_can_msgs__msg__BSUStatus01Updated
    std::shared_ptr<sd_can_msgs::msg::BSUStatus01Updated_<ContainerAllocator> const>
  ...
  bool operator==(const BSUStatus01Updated_ & other) const
  {
...
using BSUStatus01Updated =
  sd_can_msgs::msg::BSUStatus01Updated_<std::allocator<void>>;

// constant definitions
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t BSUStatus01Updated_<ContainerAllocator>::BSU_HL_STOP_REQUEST_FALSE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t BSUStatus01Updated_<ContainerAllocator>::BSU_HL_STOP_REQUEST_TRUE;
#endif  // __cplusplus < 201703L
...
#endif  // SD_CAN_MSGS__MSG__DETAIL__BSU_STATUS01_UPDATED__STRUCT_HPP_
