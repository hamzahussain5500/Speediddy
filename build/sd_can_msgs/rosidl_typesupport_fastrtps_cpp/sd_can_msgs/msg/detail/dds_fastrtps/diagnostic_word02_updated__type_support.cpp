...
#include "sd_can_msgs/msg/detail/diagnostic_word02_updated__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sd_can_msgs::msg::DiagnosticWord02Updated & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sd_can_msgs::msg::DiagnosticWord02Updated & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sd_can_msgs
max_serialized_size_DiagnosticWord02Updated(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs::msg::DiagnosticWord02Updated;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::DiagnosticWord02Updated *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sd_can_msgs::msg::DiagnosticWord02Updated *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DiagnosticWord02Updated__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::DiagnosticWord02Updated *>(
...
static size_t _DiagnosticWord02Updated__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DiagnosticWord02Updated(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DiagnosticWord02Updated__callbacks = {
  "sd_can_msgs::msg",
...
static rosidl_message_type_support_t _DiagnosticWord02Updated__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DiagnosticWord02Updated__callbacks,
...
{
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_DiagnosticWord02Updated__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sd_can_msgs, msg, DiagnosticWord02Updated)() {
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_DiagnosticWord02Updated__handle;
}
