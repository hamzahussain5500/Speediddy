...
#include "sd_can_msgs/msg/detail/hlpc_info1__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sd_can_msgs::msg::HLPCInfo1 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sd_can_msgs::msg::HLPCInfo1 & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs::msg::HLPCInfo1;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::HLPCInfo1 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sd_can_msgs::msg::HLPCInfo1 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HLPCInfo1__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::HLPCInfo1 *>(
...
static size_t _HLPCInfo1__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HLPCInfo1(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HLPCInfo1__callbacks = {
  "sd_can_msgs::msg",
  "HLPCInfo1",
...
static rosidl_message_type_support_t _HLPCInfo1__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HLPCInfo1__callbacks,
...
{
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_HLPCInfo1__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sd_can_msgs, msg, HLPCInfo1)() {
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_HLPCInfo1__handle;
}
