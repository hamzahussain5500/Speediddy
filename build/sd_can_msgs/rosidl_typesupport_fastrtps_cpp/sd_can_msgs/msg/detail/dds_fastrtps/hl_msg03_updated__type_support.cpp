...
#include "sd_can_msgs/msg/detail/hl_msg03_updated__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sd_can_msgs::msg::HLMsg03Updated & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sd_can_msgs::msg::HLMsg03Updated & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sd_can_msgs
max_serialized_size_HLMsg03Updated(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs::msg::HLMsg03Updated;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::HLMsg03Updated *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sd_can_msgs::msg::HLMsg03Updated *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HLMsg03Updated__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::HLMsg03Updated *>(
...
static size_t _HLMsg03Updated__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HLMsg03Updated(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HLMsg03Updated__callbacks = {
  "sd_can_msgs::msg",
  "HLMsg03Updated",
...
static rosidl_message_type_support_t _HLMsg03Updated__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HLMsg03Updated__callbacks,
...
{
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_HLMsg03Updated__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sd_can_msgs, msg, HLMsg03Updated)() {
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_HLMsg03Updated__handle;
}
