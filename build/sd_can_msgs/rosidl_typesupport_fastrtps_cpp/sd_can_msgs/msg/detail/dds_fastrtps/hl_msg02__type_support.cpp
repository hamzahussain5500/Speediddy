...
#include "sd_can_msgs/msg/detail/hl_msg02__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sd_can_msgs::msg::HLMsg02 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sd_can_msgs::msg::HLMsg02 & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs::msg::HLMsg02;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::HLMsg02 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sd_can_msgs::msg::HLMsg02 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HLMsg02__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sd_can_msgs::msg::HLMsg02 *>(
...
static size_t _HLMsg02__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HLMsg02(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HLMsg02__callbacks = {
  "sd_can_msgs::msg",
  "HLMsg02",
...
static rosidl_message_type_support_t _HLMsg02__handle = {
...
{
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_HLMsg02__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sd_can_msgs, msg, HLMsg02)() {
  return &sd_can_msgs::msg::typesupport_fastrtps_cpp::_HLMsg02__handle;
}
