...
#ifndef SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01__STRUCT_H_
#define SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01__STRUCT_H_
...
/// Struct defined in msg/DiagnosticWord01 in the package sd_can_msgs.
typedef struct sd_can_msgs__msg__DiagnosticWord01
{
  ...
  uint8_t psa_steer_slip_warning;
  /// ===============================================
  /// Fields from the legacy message
  uint8_t ice_error_legacy;
  uint8_t emb_line_press_over_max_start_limit_legacy;
  uint8_t pdu1_counter_error_legacy;
  uint8_t pdu1_timeout_error_legacy;
  uint8_t pdu2_counter_error_legacy;
  uint8_t pdu2_timeout_error_legacy;
  uint8_t em_piston_hall_not_ready_legacy;
  uint8_t emb_tank_press_under_level1_legacy;
  uint8_t emb_tank_press_under_level2_legacy;
  uint8_t emb_tank_press_under_level3_legacy;
  uint8_t emb_tank_press_under_min_start_limit_legacy;
  uint8_t ice_over_rpm_warning_legacy;
  uint8_t ice_diagnostic_spare_legacy;
} sd_can_msgs__msg__DiagnosticWord01;

// Struct for a sequence of sd_can_msgs__msg__DiagnosticWord01.
typedef struct sd_can_msgs__msg__DiagnosticWord01__Sequence
{
...
#endif  // SD_CAN_MSGS__MSG__DETAIL__DIAGNOSTIC_WORD01__STRUCT_H_
