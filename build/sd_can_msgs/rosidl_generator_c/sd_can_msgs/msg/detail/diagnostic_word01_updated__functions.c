...
bool
sd_can_msgs__msg__DiagnosticWord01Updated__init(sd_can_msgs__msg__DiagnosticWord01Updated * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sd_can_msgs__msg__DiagnosticWord01Updated__fini(msg);
    return false;
  }
  // bms_starting_faild
  // bms_timeout_error
...
void
sd_can_msgs__msg__DiagnosticWord01Updated__fini(sd_can_msgs__msg__DiagnosticWord01Updated * msg)
{
  if (!msg) {
    return;
  }
...
bool
sd_can_msgs__msg__DiagnosticWord01Updated__are_equal(const sd_can_msgs__msg__DiagnosticWord01Updated * lhs, const sd_can_msgs__msg__DiagnosticWord01Updated * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
sd_can_msgs__msg__DiagnosticWord01Updated__copy(
  const sd_can_msgs__msg__DiagnosticWord01Updated * input,
  sd_can_msgs__msg__DiagnosticWord01Updated * output)
{
  if (!input || !output) {
    return false;
  }
...
sd_can_msgs__msg__DiagnosticWord01Updated__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sd_can_msgs__msg__DiagnosticWord01Updated * msg = (sd_can_msgs__msg__DiagnosticWord01Updated *)allocator.allocate(sizeof(sd_can_msgs__msg__DiagnosticWord01Updated), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sd_can_msgs__msg__DiagnosticWord01Updated));
  bool success = sd_can_msgs__msg__DiagnosticWord01Updated__init(msg);
  if (!success) {
...
void
sd_can_msgs__msg__DiagnosticWord01Updated__destroy(sd_can_msgs__msg__DiagnosticWord01Updated * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    sd_can_msgs__msg__DiagnosticWord01Updated__fini(msg);
...
bool
sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__init(sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sd_can_msgs__msg__DiagnosticWord01Updated * data = NULL;

  if (size) {
    data = (sd_can_msgs__msg__DiagnosticWord01Updated *)allocator.zero_allocate(size, sizeof(sd_can_msgs__msg__DiagnosticWord01Updated), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sd_can_msgs__msg__DiagnosticWord01Updated__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sd_can_msgs__msg__DiagnosticWord01Updated__fini(&data[i - 1]);
      }
...
void
sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__fini(sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sd_can_msgs__msg__DiagnosticWord01Updated__fini(&array->data[i]);
    }
...
sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * array = (sd_can_msgs__msg__DiagnosticWord01Updated__Sequence *)allocator.allocate(sizeof(sd_can_msgs__msg__DiagnosticWord01Updated__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__init(array, size);
  if (!success) {
...
void
sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__destroy(sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__are_equal(const sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * lhs, const sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sd_can_msgs__msg__DiagnosticWord01Updated__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
sd_can_msgs__msg__DiagnosticWord01Updated__Sequence__copy(
  const sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * input,
  sd_can_msgs__msg__DiagnosticWord01Updated__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sd_can_msgs__msg__DiagnosticWord01Updated);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sd_can_msgs__msg__DiagnosticWord01Updated * data =
      (sd_can_msgs__msg__DiagnosticWord01Updated *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sd_can_msgs__msg__DiagnosticWord01Updated__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sd_can_msgs__msg__DiagnosticWord01Updated__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sd_can_msgs__msg__DiagnosticWord01Updated__copy(
