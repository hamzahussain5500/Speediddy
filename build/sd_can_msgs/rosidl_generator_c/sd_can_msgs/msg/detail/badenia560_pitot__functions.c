...
sd_can_msgs__msg__Badenia560Pitot__init(sd_can_msgs__msg__Badenia560Pitot * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sd_can_msgs__msg__Badenia560Pitot__fini(msg);
    return false;
  }
  // pitot_front_press
  // pitot_yaw_press
...
sd_can_msgs__msg__Badenia560Pitot__create()
{
  ...
  sd_can_msgs__msg__Badenia560Pitot * msg = (sd_can_msgs__msg__Badenia560Pitot *)allocator.allocate(sizeof(sd_can_msgs__msg__Badenia560Pitot), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sd_can_msgs__msg__Badenia560Pitot));
  bool success = sd_can_msgs__msg__Badenia560Pitot__init(msg);
  if (!success) {
...
sd_can_msgs__msg__Badenia560Pitot__Sequence__init(sd_can_msgs__msg__Badenia560Pitot__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sd_can_msgs__msg__Badenia560Pitot * data = NULL;

  if (size) {
    data = (sd_can_msgs__msg__Badenia560Pitot *)allocator.zero_allocate(size, sizeof(sd_can_msgs__msg__Badenia560Pitot), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sd_can_msgs__msg__Badenia560Pitot__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sd_can_msgs__msg__Badenia560Pitot__fini(&data[i - 1]);
      }
...
sd_can_msgs__msg__Badenia560Pitot__Sequence__fini(sd_can_msgs__msg__Badenia560Pitot__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sd_can_msgs__msg__Badenia560Pitot__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sd_can_msgs__msg__Badenia560Pitot__Sequence * array = (sd_can_msgs__msg__Badenia560Pitot__Sequence *)allocator.allocate(sizeof(sd_can_msgs__msg__Badenia560Pitot__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sd_can_msgs__msg__Badenia560Pitot__Sequence__init(array, size);
  if (!success) {
...
sd_can_msgs__msg__Badenia560Pitot__Sequence__destroy(sd_can_msgs__msg__Badenia560Pitot__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sd_can_msgs__msg__Badenia560Pitot__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sd_can_msgs__msg__Badenia560Pitot__Sequence__are_equal(const sd_can_msgs__msg__Badenia560Pitot__Sequence * lhs, const sd_can_msgs__msg__Badenia560Pitot__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sd_can_msgs__msg__Badenia560Pitot__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sd_can_msgs__msg__Badenia560Pitot__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sd_can_msgs__msg__Badenia560Pitot);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sd_can_msgs__msg__Badenia560Pitot * data =
      (sd_can_msgs__msg__Badenia560Pitot *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sd_can_msgs__msg__Badenia560Pitot__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sd_can_msgs__msg__Badenia560Pitot__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sd_can_msgs__msg__Badenia560Pitot__copy(
