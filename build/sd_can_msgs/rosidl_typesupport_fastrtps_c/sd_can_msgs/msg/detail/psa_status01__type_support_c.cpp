...
#include "sd_can_msgs/msg/detail/psa_status01__rosidl_typesupport_fastrtps_c.h"
...
using _PSAStatus01__ros_msg_type = sd_can_msgs__msg__PSAStatus01;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PSAStatus01__ros_msg_type * ros_message = static_cast<const _PSAStatus01__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: psa_actual_pos_rad
  {
    cdr << ros_message->psa_actual_pos_rad;
  }

  // Field name: psa_actual_speed_rad_s
  {
    cdr << ros_message->psa_actual_speed_rad_s;
  }

  // Field name: psa_actual_torque_m_nm
  {
    cdr << ros_message->psa_actual_torque_m_nm;
  }

  // Field name: psa_actual_mode_of_operation
  {
    cdr << ros_message->psa_actual_mode_of_operation;
  }

  // Field name: psa_actual_current_a
  {
    cdr << ros_message->psa_actual_current_a;
  }

  // Field name: psa_actual_voltage_v
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PSAStatus01__ros_msg_type * ros_message = static_cast<_PSAStatus01__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_sd_can_msgs__msg__PSAStatus01(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PSAStatus01__ros_msg_type * ros_message = static_cast<const _PSAStatus01__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PSAStatus01__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sd_can_msgs__msg__PSAStatus01(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sd_can_msgs
size_t max_serialized_size_sd_can_msgs__msg__PSAStatus01(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs__msg__PSAStatus01;
    is_plain =
      (
...
static size_t _PSAStatus01__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sd_can_msgs__msg__PSAStatus01(
...
static message_type_support_callbacks_t __callbacks_PSAStatus01 = {
  "sd_can_msgs::msg",
  "PSAStatus01",
...
static rosidl_message_type_support_t _PSAStatus01__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PSAStatus01,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sd_can_msgs, msg, PSAStatus01)() {
  return &_PSAStatus01__type_support;
}
