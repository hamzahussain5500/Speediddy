...
#include "sd_can_msgs/msg/detail/diagnostic_word01__rosidl_typesupport_fastrtps_c.h"
...
using _DiagnosticWord01__ros_msg_type = sd_can_msgs__msg__DiagnosticWord01;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DiagnosticWord01__ros_msg_type * ros_message = static_cast<const _DiagnosticWord01__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: ecu_timeout_em_fault
  {
    cdr << ros_message->ecu_timeout_em_fault;
  }

  // Field name: dem_cbafl_not_receive
  {
  ...
  // Field name: dem_pdu12_v_not_receive
  {
  ...
  // Field name: dem_cbafr_not_receive
  {
  ...
  // Field name: pdu12_counter_error
  {
    cdr << ros_message->pdu12_counter_error;
  }

  // Field name: pdu12_timeout_error
  {
    cdr << ros_message->pdu12_timeout_error;
  }

  // Field name: pdu48_counter_error
  {
    cdr << ros_message->pdu48_counter_error;
  }

  // Field name: pdu48_timeout_error
  {
    cdr << ros_message->pdu48_timeout_error;
  }

  // Field name: dem_cbarl_not_receive
  {
  ...
  // Field name: dem_cbarr_not_receive
  {
    cdr << ros_message->dem_cbarr_not_receive;
  }

  // Field name: em_stop_conditions_active
  {
    cdr << ros_message->em_stop_conditions_active;
  }

  // Field name: ml_stop_conditions_active
  {
    cdr << ros_message->ml_stop_conditions_active;
  }

  // Field name: dcdc4812_under_min_start_limit
  {
  ...
  // Field name: pdu12_active_anti_fire
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DiagnosticWord01__ros_msg_type * ros_message = static_cast<_DiagnosticWord01__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_sd_can_msgs__msg__DiagnosticWord01(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DiagnosticWord01__ros_msg_type * ros_message = static_cast<const _DiagnosticWord01__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DiagnosticWord01__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sd_can_msgs__msg__DiagnosticWord01(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sd_can_msgs
size_t max_serialized_size_sd_can_msgs__msg__DiagnosticWord01(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs__msg__DiagnosticWord01;
    is_plain =
      (
...
static size_t _DiagnosticWord01__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sd_can_msgs__msg__DiagnosticWord01(
...
static message_type_support_callbacks_t __callbacks_DiagnosticWord01 = {
  "sd_can_msgs::msg",
  "DiagnosticWord01",
...
static rosidl_message_type_support_t _DiagnosticWord01__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DiagnosticWord01,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sd_can_msgs, msg, DiagnosticWord01)() {
  return &_DiagnosticWord01__type_support;
}
