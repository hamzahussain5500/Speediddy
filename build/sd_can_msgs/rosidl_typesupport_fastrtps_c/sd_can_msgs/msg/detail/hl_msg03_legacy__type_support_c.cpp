...
#include "sd_can_msgs/msg/detail/hl_msg03_legacy__rosidl_typesupport_fastrtps_c.h"
...
using _HLMsg03Legacy__ros_msg_type = sd_can_msgs__msg__HLMsg03Legacy;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HLMsg03Legacy__ros_msg_type * ros_message = static_cast<const _HLMsg03Legacy__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: hl_pdu1_activate_gnss
  {
    cdr << ros_message->hl_pdu1_activate_gnss;
  }

  // Field name: hl_pdu1_activate_oss
  {
  ...
  // Field name: hl_pdu1_activate_lidar_r
  {
    cdr << ros_message->hl_pdu1_activate_lidar_r;
  }

  // Field name: hl_pdu1_activate_lidar_cn
  {
    cdr << ros_message->hl_pdu1_activate_lidar_cn;
  }

  // Field name: hl_pdu1_activate_lidar_l
  {
    cdr << ros_message->hl_pdu1_activate_lidar_l;
  }

  // Field name: hl_pdu1_activate_radar_rear
  {
    cdr << ros_message->hl_pdu1_activate_radar_rear;
  }

  // Field name: hl_pdu1_activate_radar_cn
  {
    cdr << ros_message->hl_pdu1_activate_radar_cn;
  }

  // Field name: hl_pdu1_activate_radar_r
  {
    cdr << ros_message->hl_pdu1_activate_radar_r;
  }

  // Field name: hl_pdu1_activate_radar_l
  {
  ...
  void * untyped_ros_message)
{
  ...
  _HLMsg03Legacy__ros_msg_type * ros_message = static_cast<_HLMsg03Legacy__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_sd_can_msgs__msg__HLMsg03Legacy(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HLMsg03Legacy__ros_msg_type * ros_message = static_cast<const _HLMsg03Legacy__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _HLMsg03Legacy__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sd_can_msgs__msg__HLMsg03Legacy(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sd_can_msgs
size_t max_serialized_size_sd_can_msgs__msg__HLMsg03Legacy(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs__msg__HLMsg03Legacy;
    is_plain =
      (
...
static size_t _HLMsg03Legacy__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sd_can_msgs__msg__HLMsg03Legacy(
...
static message_type_support_callbacks_t __callbacks_HLMsg03Legacy = {
  "sd_can_msgs::msg",
  "HLMsg03Legacy",
...
static rosidl_message_type_support_t _HLMsg03Legacy__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HLMsg03Legacy,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sd_can_msgs, msg, HLMsg03Legacy)() {
  return &_HLMsg03Legacy__type_support;
}
