...
#include "sd_can_msgs/msg/detail/diagnostic_word01_updated__rosidl_typesupport_fastrtps_c.h"
...
using _DiagnosticWord01Updated__ros_msg_type = sd_can_msgs__msg__DiagnosticWord01Updated;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DiagnosticWord01Updated__ros_msg_type * ros_message = static_cast<const _DiagnosticWord01Updated__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DiagnosticWord01Updated__ros_msg_type * ros_message = static_cast<_DiagnosticWord01Updated__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_sd_can_msgs__msg__DiagnosticWord01Updated(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DiagnosticWord01Updated__ros_msg_type * ros_message = static_cast<const _DiagnosticWord01Updated__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DiagnosticWord01Updated__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sd_can_msgs__msg__DiagnosticWord01Updated(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sd_can_msgs
size_t max_serialized_size_sd_can_msgs__msg__DiagnosticWord01Updated(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs__msg__DiagnosticWord01Updated;
    is_plain =
      (
...
static size_t _DiagnosticWord01Updated__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sd_can_msgs__msg__DiagnosticWord01Updated(
...
static message_type_support_callbacks_t __callbacks_DiagnosticWord01Updated = {
  "sd_can_msgs::msg",
...
static rosidl_message_type_support_t _DiagnosticWord01Updated__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DiagnosticWord01Updated,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sd_can_msgs, msg, DiagnosticWord01Updated)() {
  return &_DiagnosticWord01Updated__type_support;
}
