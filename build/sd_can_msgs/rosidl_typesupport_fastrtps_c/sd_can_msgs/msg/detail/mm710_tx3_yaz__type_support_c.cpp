...
#include "sd_can_msgs/msg/detail/mm710_tx3_yaz__rosidl_typesupport_fastrtps_c.h"
...
using _MM710TX3YAZ__ros_msg_type = sd_can_msgs__msg__MM710TX3YAZ;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MM710TX3YAZ__ros_msg_type * ros_message = static_cast<const _MM710TX3YAZ__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MM710TX3YAZ__ros_msg_type * ros_message = static_cast<_MM710TX3YAZ__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_sd_can_msgs__msg__MM710TX3YAZ(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MM710TX3YAZ__ros_msg_type * ros_message = static_cast<const _MM710TX3YAZ__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MM710TX3YAZ__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sd_can_msgs__msg__MM710TX3YAZ(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sd_can_msgs
size_t max_serialized_size_sd_can_msgs__msg__MM710TX3YAZ(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sd_can_msgs__msg__MM710TX3YAZ;
    is_plain =
      (
...
static size_t _MM710TX3YAZ__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sd_can_msgs__msg__MM710TX3YAZ(
...
static message_type_support_callbacks_t __callbacks_MM710TX3YAZ = {
  "sd_can_msgs::msg",
  "MM710TX3YAZ",
...
static rosidl_message_type_support_t _MM710TX3YAZ__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MM710TX3YAZ,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sd_can_msgs, msg, MM710TX3YAZ)() {
  return &_MM710TX3YAZ__type_support;
}
