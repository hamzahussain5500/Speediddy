...
bool sd_can_msgs__msg__texib6r_tx1__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._texib6r_tx1.TEXIB6rTx1", full_classname_dest, 39) == 0);
  }
  sd_can_msgs__msg__TEXIB6rTx1 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TEXIB6rTx1 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._texib6r_tx1");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TEXIB6rTx1");
