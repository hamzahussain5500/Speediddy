...
class Metaclass_TEXIB6rTx1(type):
    """Metaclass of message 'TEXIB6rTx1'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.TEXIB6rTx1')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__texib6r_tx1
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__texib6r_tx1
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__texib6r_tx1
            cls._TYPE_SUPPORT = module.type_support_msg__msg__texib6r_tx1
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__texib6r_tx1
...
class TEXIB6rTx1(metaclass=Metaclass_TEXIB6rTx1):
    """Message class 'TEXIB6rTx1'."""
