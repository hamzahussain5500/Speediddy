...
class Metaclass_DiagnosticWord01(type):
    """Metaclass of message 'DiagnosticWord01'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.DiagnosticWord01')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__diagnostic_word01
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__diagnostic_word01
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__diagnostic_word01
            cls._TYPE_SUPPORT = module.type_support_msg__msg__diagnostic_word01
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__diagnostic_word01
...
class DiagnosticWord01(metaclass=Metaclass_DiagnosticWord01):
    """Message class 'DiagnosticWord01'."""
    ...
    __slots__ = [
        ...
        '_rm_counter_error',
        '_rm_timeout_error',
        '_psa_steer_slip_warning',
        '_ice_error_legacy',
        '_emb_line_press_over_max_start_limit_legacy',
        '_pdu1_counter_error_legacy',
        '_pdu1_timeout_error_legacy',
        '_pdu2_counter_error_legacy',
        '_pdu2_timeout_error_legacy',
        '_em_piston_hall_not_ready_legacy',
        '_emb_tank_press_under_level1_legacy',
        '_emb_tank_press_under_level2_legacy',
        '_emb_tank_press_under_level3_legacy',
        '_emb_tank_press_under_min_start_limit_legacy',
        '_ice_over_rpm_warning_legacy',
        '_ice_diagnostic_spare_legacy',
    ]
    ...
    _fields_and_field_types = {
        ...
        'psa_steer_slip_warning': 'uint8',
        'ice_error_legacy': 'uint8',
        'emb_line_press_over_max_start_limit_legacy': 'uint8',
        'pdu1_counter_error_legacy': 'uint8',
        'pdu1_timeout_error_legacy': 'uint8',
        'pdu2_counter_error_legacy': 'uint8',
        'pdu2_timeout_error_legacy': 'uint8',
        'em_piston_hall_not_ready_legacy': 'uint8',
        'emb_tank_press_under_level1_legacy': 'uint8',
        'emb_tank_press_under_level2_legacy': 'uint8',
        'emb_tank_press_under_level3_legacy': 'uint8',
        'emb_tank_press_under_min_start_limit_legacy': 'uint8',
        'ice_over_rpm_warning_legacy': 'uint8',
        'ice_diagnostic_spare_legacy': 'uint8',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.psa_steer_slip_warning = kwargs.get('psa_steer_slip_warning', int())
        self.ice_error_legacy = kwargs.get('ice_error_legacy', int())
        self.emb_line_press_over_max_start_limit_legacy = kwargs.get('emb_line_press_over_max_start_limit_legacy', int())
        self.pdu1_counter_error_legacy = kwargs.get('pdu1_counter_error_legacy', int())
        self.pdu1_timeout_error_legacy = kwargs.get('pdu1_timeout_error_legacy', int())
        self.pdu2_counter_error_legacy = kwargs.get('pdu2_counter_error_legacy', int())
        self.pdu2_timeout_error_legacy = kwargs.get('pdu2_timeout_error_legacy', int())
        self.em_piston_hall_not_ready_legacy = kwargs.get('em_piston_hall_not_ready_legacy', int())
        self.emb_tank_press_under_level1_legacy = kwargs.get('emb_tank_press_under_level1_legacy', int())
        self.emb_tank_press_under_level2_legacy = kwargs.get('emb_tank_press_under_level2_legacy', int())
        self.emb_tank_press_under_level3_legacy = kwargs.get('emb_tank_press_under_level3_legacy', int())
        self.emb_tank_press_under_min_start_limit_legacy = kwargs.get('emb_tank_press_under_min_start_limit_legacy', int())
        self.ice_over_rpm_warning_legacy = kwargs.get('ice_over_rpm_warning_legacy', int())
        self.ice_diagnostic_spare_legacy = kwargs.get('ice_diagnostic_spare_legacy', int())
    ...
    def __eq__(self, other):
        ...
        if self.rm_timeout_error != other.rm_timeout_error:
            return False
        if self.psa_steer_slip_warning != other.psa_steer_slip_warning:
            return False
        if self.ice_error_legacy != other.ice_error_legacy:
            return False
        if self.emb_line_press_over_max_start_limit_legacy != other.emb_line_press_over_max_start_limit_legacy:
            return False
        if self.pdu1_counter_error_legacy != other.pdu1_counter_error_legacy:
            return False
        if self.pdu1_timeout_error_legacy != other.pdu1_timeout_error_legacy:
            return False
        if self.pdu2_counter_error_legacy != other.pdu2_counter_error_legacy:
            return False
        if self.pdu2_timeout_error_legacy != other.pdu2_timeout_error_legacy:
            return False
        if self.em_piston_hall_not_ready_legacy != other.em_piston_hall_not_ready_legacy:
            return False
        if self.emb_tank_press_under_level1_legacy != other.emb_tank_press_under_level1_legacy:
            return False
        if self.emb_tank_press_under_level2_legacy != other.emb_tank_press_under_level2_legacy:
            return False
        if self.emb_tank_press_under_level3_legacy != other.emb_tank_press_under_level3_legacy:
            return False
        if self.emb_tank_press_under_min_start_limit_legacy != other.emb_tank_press_under_min_start_limit_legacy:
            return False
        if self.ice_over_rpm_warning_legacy != other.ice_over_rpm_warning_legacy:
            return False
        if self.ice_diagnostic_spare_legacy != other.ice_diagnostic_spare_legacy:
            return False
        return True
    ...
    @builtins.property
    def psa_steer_slip_warning(self):
        """Message field 'psa_steer_slip_warning'."""
        return self._psa_steer_slip_warning

    @psa_steer_slip_warning.setter
    def psa_steer_slip_warning(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'psa_steer_slip_warning' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'psa_steer_slip_warning' field must be an unsigned integer in [0, 255]"
        self._psa_steer_slip_warning = value

    @builtins.property
    def ice_error_legacy(self):
        """Message field 'ice_error_legacy'."""
        return self._ice_error_legacy

    @ice_error_legacy.setter
    def ice_error_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'ice_error_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'ice_error_legacy' field must be an unsigned integer in [0, 255]"
        self._ice_error_legacy = value

    @builtins.property
    def emb_line_press_over_max_start_limit_legacy(self):
        """Message field 'emb_line_press_over_max_start_limit_legacy'."""
        return self._emb_line_press_over_max_start_limit_legacy

    @emb_line_press_over_max_start_limit_legacy.setter
    def emb_line_press_over_max_start_limit_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'emb_line_press_over_max_start_limit_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'emb_line_press_over_max_start_limit_legacy' field must be an unsigned integer in [0, 255]"
        self._emb_line_press_over_max_start_limit_legacy = value

    @builtins.property
    def pdu1_counter_error_legacy(self):
        """Message field 'pdu1_counter_error_legacy'."""
        return self._pdu1_counter_error_legacy

    @pdu1_counter_error_legacy.setter
    def pdu1_counter_error_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu1_counter_error_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu1_counter_error_legacy' field must be an unsigned integer in [0, 255]"
        self._pdu1_counter_error_legacy = value

    @builtins.property
    def pdu1_timeout_error_legacy(self):
        """Message field 'pdu1_timeout_error_legacy'."""
        return self._pdu1_timeout_error_legacy

    @pdu1_timeout_error_legacy.setter
    def pdu1_timeout_error_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu1_timeout_error_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu1_timeout_error_legacy' field must be an unsigned integer in [0, 255]"
        self._pdu1_timeout_error_legacy = value

    @builtins.property
    def pdu2_counter_error_legacy(self):
        """Message field 'pdu2_counter_error_legacy'."""
        return self._pdu2_counter_error_legacy

    @pdu2_counter_error_legacy.setter
    def pdu2_counter_error_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu2_counter_error_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu2_counter_error_legacy' field must be an unsigned integer in [0, 255]"
        self._pdu2_counter_error_legacy = value

    @builtins.property
    def pdu2_timeout_error_legacy(self):
        """Message field 'pdu2_timeout_error_legacy'."""
        return self._pdu2_timeout_error_legacy

    @pdu2_timeout_error_legacy.setter
    def pdu2_timeout_error_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu2_timeout_error_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu2_timeout_error_legacy' field must be an unsigned integer in [0, 255]"
        self._pdu2_timeout_error_legacy = value

    @builtins.property
    def em_piston_hall_not_ready_legacy(self):
        """Message field 'em_piston_hall_not_ready_legacy'."""
        return self._em_piston_hall_not_ready_legacy

    @em_piston_hall_not_ready_legacy.setter
    def em_piston_hall_not_ready_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'em_piston_hall_not_ready_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'em_piston_hall_not_ready_legacy' field must be an unsigned integer in [0, 255]"
        self._em_piston_hall_not_ready_legacy = value

    @builtins.property
    def emb_tank_press_under_level1_legacy(self):
        """Message field 'emb_tank_press_under_level1_legacy'."""
        return self._emb_tank_press_under_level1_legacy

    @emb_tank_press_under_level1_legacy.setter
    def emb_tank_press_under_level1_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'emb_tank_press_under_level1_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'emb_tank_press_under_level1_legacy' field must be an unsigned integer in [0, 255]"
        self._emb_tank_press_under_level1_legacy = value

    @builtins.property
    def emb_tank_press_under_level2_legacy(self):
        """Message field 'emb_tank_press_under_level2_legacy'."""
        return self._emb_tank_press_under_level2_legacy

    @emb_tank_press_under_level2_legacy.setter
    def emb_tank_press_under_level2_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'emb_tank_press_under_level2_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'emb_tank_press_under_level2_legacy' field must be an unsigned integer in [0, 255]"
        self._emb_tank_press_under_level2_legacy = value

    @builtins.property
    def emb_tank_press_under_level3_legacy(self):
        """Message field 'emb_tank_press_under_level3_legacy'."""
        return self._emb_tank_press_under_level3_legacy

    @emb_tank_press_under_level3_legacy.setter
    def emb_tank_press_under_level3_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'emb_tank_press_under_level3_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'emb_tank_press_under_level3_legacy' field must be an unsigned integer in [0, 255]"
        self._emb_tank_press_under_level3_legacy = value

    @builtins.property
    def emb_tank_press_under_min_start_limit_legacy(self):
        """Message field 'emb_tank_press_under_min_start_limit_legacy'."""
        return self._emb_tank_press_under_min_start_limit_legacy

    @emb_tank_press_under_min_start_limit_legacy.setter
    def emb_tank_press_under_min_start_limit_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'emb_tank_press_under_min_start_limit_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'emb_tank_press_under_min_start_limit_legacy' field must be an unsigned integer in [0, 255]"
        self._emb_tank_press_under_min_start_limit_legacy = value

    @builtins.property
    def ice_over_rpm_warning_legacy(self):
        """Message field 'ice_over_rpm_warning_legacy'."""
        return self._ice_over_rpm_warning_legacy

    @ice_over_rpm_warning_legacy.setter
    def ice_over_rpm_warning_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'ice_over_rpm_warning_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'ice_over_rpm_warning_legacy' field must be an unsigned integer in [0, 255]"
        self._ice_over_rpm_warning_legacy = value

    @builtins.property
    def ice_diagnostic_spare_legacy(self):
        """Message field 'ice_diagnostic_spare_legacy'."""
        return self._ice_diagnostic_spare_legacy

    @ice_diagnostic_spare_legacy.setter
    def ice_diagnostic_spare_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'ice_diagnostic_spare_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'ice_diagnostic_spare_legacy' field must be an unsigned integer in [0, 255]"
        self._ice_diagnostic_spare_legacy = value
