...
bool sd_can_msgs__msg__bsu_status01__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._bsu_status01.BSUStatus01", full_classname_dest, 41) == 0);
  }
  sd_can_msgs__msg__BSUStatus01 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BSUStatus01 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._bsu_status01");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BSUStatus01");
