...
bool sd_can_msgs__msg__diagnostic_word02__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._diagnostic_word02.DiagnosticWord02", full_classname_dest, 51) == 0);
  }
  sd_can_msgs__msg__DiagnosticWord02 * ros_message = _ros_message;
  {  // header
  ...
  {  // psa_sat_rates_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "psa_sat_rates_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->psa_sat_rates_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms12_soc_under_level1
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms12_soc_under_level1");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms12_soc_under_level1 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms12_soc_under_level2
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms12_soc_under_level2");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms12_soc_under_level2 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms12_temp_over_level1
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms12_temp_over_level1");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms12_temp_over_level1 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms12_temp_over_level2
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms12_temp_over_level2");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms12_temp_over_level2 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms48_soc_under_level1
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms48_soc_under_level1");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms48_soc_under_level1 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms48_soc_under_level2
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms48_soc_under_level2");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms48_soc_under_level2 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms48_temp_over_level1
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms48_temp_over_level1");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms48_temp_over_level1 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms48_temp_over_level2
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms48_temp_over_level2");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms48_temp_over_level2 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // badenia_counter_error
    PyObject * field = PyObject_GetAttrString(_pymsg, "badenia_counter_error");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->badenia_counter_error = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // badenia_timeout_error
    PyObject * field = PyObject_GetAttrString(_pymsg, "badenia_timeout_error");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->badenia_timeout_error = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // rm_em_flag
    PyObject * field = PyObject_GetAttrString(_pymsg, "rm_em_flag");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->rm_em_flag = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // ml_stop_brake_bias_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "ml_stop_brake_bias_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ml_stop_brake_bias_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // limp_ice_sat_values_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "limp_ice_sat_values_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->limp_ice_sat_values_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // cba_sat_rates_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "cba_sat_rates_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->cba_sat_rates_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // limp_cba_sat_values_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "limp_cba_sat_values_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->limp_cba_sat_values_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // p2p_max_num_activation_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "p2p_max_num_activation_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->p2p_max_num_activation_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // p2p_cooldown_duration_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "p2p_cooldown_duration_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->p2p_cooldown_duration_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // p2p_active_duration_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "p2p_active_duration_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->p2p_active_duration_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // rc_delta_timeout_lim_def_val
    PyObject * field = PyObject_GetAttrString(_pymsg, "rc_delta_timeout_lim_def_val");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->rc_delta_timeout_lim_def_val = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // hl_mlsupervisor_request
    PyObject * field = PyObject_GetAttrString(_pymsg, "hl_mlsupervisor_request");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->hl_mlsupervisor_request = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of DiagnosticWord02 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._diagnostic_word02");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DiagnosticWord02");
  ...
  {  // psa_sat_rates_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->psa_sat_rates_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "psa_sat_rates_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms12_soc_under_level1
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms12_soc_under_level1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms12_soc_under_level1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms12_soc_under_level2
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms12_soc_under_level2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms12_soc_under_level2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms12_temp_over_level1
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms12_temp_over_level1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms12_temp_over_level1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms12_temp_over_level2
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms12_temp_over_level2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms12_temp_over_level2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms48_soc_under_level1
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms48_soc_under_level1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms48_soc_under_level1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms48_soc_under_level2
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms48_soc_under_level2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms48_soc_under_level2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms48_temp_over_level1
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms48_temp_over_level1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms48_temp_over_level1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms48_temp_over_level2
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms48_temp_over_level2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms48_temp_over_level2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // badenia_counter_error
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->badenia_counter_error);
    {
      int rc = PyObject_SetAttrString(_pymessage, "badenia_counter_error", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // badenia_timeout_error
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->badenia_timeout_error);
    {
      int rc = PyObject_SetAttrString(_pymessage, "badenia_timeout_error", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // rm_em_flag
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->rm_em_flag);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rm_em_flag", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ml_stop_brake_bias_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->ml_stop_brake_bias_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ml_stop_brake_bias_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // limp_ice_sat_values_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->limp_ice_sat_values_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "limp_ice_sat_values_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cba_sat_rates_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->cba_sat_rates_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cba_sat_rates_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // limp_cba_sat_values_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->limp_cba_sat_values_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "limp_cba_sat_values_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // p2p_max_num_activation_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->p2p_max_num_activation_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "p2p_max_num_activation_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // p2p_cooldown_duration_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->p2p_cooldown_duration_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "p2p_cooldown_duration_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // p2p_active_duration_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->p2p_active_duration_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "p2p_active_duration_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // rc_delta_timeout_lim_def_val
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->rc_delta_timeout_lim_def_val);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rc_delta_timeout_lim_def_val", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // hl_mlsupervisor_request
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->hl_mlsupervisor_request);
    {
      int rc = PyObject_SetAttrString(_pymessage, "hl_mlsupervisor_request", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
