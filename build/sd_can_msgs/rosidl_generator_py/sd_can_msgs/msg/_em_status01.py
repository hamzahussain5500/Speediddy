...
class Metaclass_EMStatus01(type):
    """Metaclass of message 'EMStatus01'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.EMStatus01')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__em_status01
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__em_status01
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__em_status01
            cls._TYPE_SUPPORT = module.type_support_msg__msg__em_status01
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__em_status01
...
class EMStatus01(metaclass=Metaclass_EMStatus01):
    """Message class 'EMStatus01'."""
    ...
    __slots__ = [
        ...
        '_emb_line_pressure_bar_legacy',
        '_emb_tank_pressure_bar_legacy',
    ]

    _fields_and_field_types = {
        'header': 'std_msgs/Header',
        'dcdc4812_voltage_v': 'uint8',
        'em_status': 'uint16',
        'hl_stop_deceleration_1': 'double',
        'hl_stop_deceleration_2': 'double',
        'hl_stop_time_to_dec_1': 'double',
        'hl_stop_time_to_dec_2': 'double',
        'emb_line_pressure_bar_legacy': 'double',
        'emb_tank_pressure_bar_legacy': 'double',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.dcdc4812_voltage_v = kwargs.get('dcdc4812_voltage_v', int())
        ...
        self.emb_line_pressure_bar_legacy = kwargs.get('emb_line_pressure_bar_legacy', float())
        self.emb_tank_pressure_bar_legacy = kwargs.get('emb_tank_pressure_bar_legacy', float())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.dcdc4812_voltage_v != other.dcdc4812_voltage_v:
            return False
        ...
        if self.hl_stop_time_to_dec_2 != other.hl_stop_time_to_dec_2:
            return False
        if self.emb_line_pressure_bar_legacy != other.emb_line_pressure_bar_legacy:
            return False
        if self.emb_tank_pressure_bar_legacy != other.emb_tank_pressure_bar_legacy:
            return False
        return True
    ...
    @builtins.property
    def dcdc4812_voltage_v(self):
        """Message field 'dcdc4812_voltage_v'."""
        return self._dcdc4812_voltage_v

    @dcdc4812_voltage_v.setter
    def dcdc4812_voltage_v(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'dcdc4812_voltage_v' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'dcdc4812_voltage_v' field must be an unsigned integer in [0, 255]"
        self._dcdc4812_voltage_v = value
    ...
    @builtins.property
    def emb_line_pressure_bar_legacy(self):
        """Message field 'emb_line_pressure_bar_legacy'."""
        return self._emb_line_pressure_bar_legacy

    @emb_line_pressure_bar_legacy.setter
    def emb_line_pressure_bar_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'emb_line_pressure_bar_legacy' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'emb_line_pressure_bar_legacy' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._emb_line_pressure_bar_legacy = value

    @builtins.property
    def emb_tank_pressure_bar_legacy(self):
        """Message field 'emb_tank_pressure_bar_legacy'."""
        return self._emb_tank_pressure_bar_legacy

    @emb_tank_pressure_bar_legacy.setter
    def emb_tank_pressure_bar_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'emb_tank_pressure_bar_legacy' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'emb_tank_pressure_bar_legacy' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._emb_tank_pressure_bar_legacy = value
