...
class Metaclass_SwVersions01Updated(type):
    """Metaclass of message 'SwVersions01Updated'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.SwVersions01Updated')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sw_versions01_updated
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sw_versions01_updated
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sw_versions01_updated
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sw_versions01_updated
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sw_versions01_updated
...
class SwVersions01Updated(metaclass=Metaclass_SwVersions01Updated):
    """Message class 'SwVersions01Updated'."""
