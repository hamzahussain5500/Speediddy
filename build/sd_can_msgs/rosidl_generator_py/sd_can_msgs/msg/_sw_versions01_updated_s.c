...
bool sd_can_msgs__msg__sw_versions01_updated__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._sw_versions01_updated.SwVersions01Updated", full_classname_dest, 58) == 0);
  }
  sd_can_msgs__msg__SwVersions01Updated * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SwVersions01Updated */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._sw_versions01_updated");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SwVersions01Updated");
