...
bool sd_can_msgs__msg__sw_versions01_legacy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._sw_versions01_legacy.SwVersions01Legacy", full_classname_dest, 56) == 0);
  }
  sd_can_msgs__msg__SwVersions01Legacy * ros_message = _ros_message;
  {  // header
  ...
  {  // pdu1_sw_version
    PyObject * field = PyObject_GetAttrString(_pymsg, "pdu1_sw_version");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->pdu1_sw_version = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pdu2_sw_version
    PyObject * field = PyObject_GetAttrString(_pymsg, "pdu2_sw_version");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->pdu2_sw_version = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of SwVersions01Legacy */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._sw_versions01_legacy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SwVersions01Legacy");
  ...
  {  // pdu1_sw_version
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pdu1_sw_version);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pdu1_sw_version", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pdu2_sw_version
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pdu2_sw_version);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pdu2_sw_version", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
