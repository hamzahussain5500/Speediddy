...
class Metaclass_BSUStatus01(type):
    """Metaclass of message 'BSUStatus01'."""
    ...
    __constants = {
        ...
        'BSU_ML_STOP_ACTIVATED_LEVEL0': 0,
        'BSU_ML_STOP_ACTIVATED_LEVEL1': 1,
        'BSU_ML_STOP_ACTIVATED_LEVEL2': 2,
        'BSU_ML_STOP_ACTIVATED_LEVEL3': 3,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.BSUStatus01')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__bsu_status01
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__bsu_status01
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__bsu_status01
            cls._TYPE_SUPPORT = module.type_support_msg__msg__bsu_status01
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__bsu_status01
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'BSU_ML_STOP_ACTIVATED_LEVEL0': cls.__constants['BSU_ML_STOP_ACTIVATED_LEVEL0'],
            'BSU_ML_STOP_ACTIVATED_LEVEL1': cls.__constants['BSU_ML_STOP_ACTIVATED_LEVEL1'],
            'BSU_ML_STOP_ACTIVATED_LEVEL2': cls.__constants['BSU_ML_STOP_ACTIVATED_LEVEL2'],
            'BSU_ML_STOP_ACTIVATED_LEVEL3': cls.__constants['BSU_ML_STOP_ACTIVATED_LEVEL3'],
        }

    @property
    def BSU_HL_STOP_REQUEST_FALSE(self):
        """Message constant 'BSU_HL_STOP_REQUEST_FALSE'."""
        return Metaclass_BSUStatus01.__constants['BSU_HL_STOP_REQUEST_FALSE']

    @property
    def BSU_HL_STOP_REQUEST_TRUE(self):
        """Message constant 'BSU_HL_STOP_REQUEST_TRUE'."""
        return Metaclass_BSUStatus01.__constants['BSU_HL_STOP_REQUEST_TRUE']

    @property
    def BSU_ML_STOP_ACTIVATED_LEVEL0(self):
        """Message constant 'BSU_ML_STOP_ACTIVATED_LEVEL0'."""
        return Metaclass_BSUStatus01.__constants['BSU_ML_STOP_ACTIVATED_LEVEL0']

    @property
    def BSU_ML_STOP_ACTIVATED_LEVEL1(self):
        """Message constant 'BSU_ML_STOP_ACTIVATED_LEVEL1'."""
        return Metaclass_BSUStatus01.__constants['BSU_ML_STOP_ACTIVATED_LEVEL1']

    @property
    def BSU_ML_STOP_ACTIVATED_LEVEL2(self):
        """Message constant 'BSU_ML_STOP_ACTIVATED_LEVEL2'."""
        return Metaclass_BSUStatus01.__constants['BSU_ML_STOP_ACTIVATED_LEVEL2']

    @property
    def BSU_ML_STOP_ACTIVATED_LEVEL3(self):
        """Message constant 'BSU_ML_STOP_ACTIVATED_LEVEL3'."""
        return Metaclass_BSUStatus01.__constants['BSU_ML_STOP_ACTIVATED_LEVEL3']


class BSUStatus01(metaclass=Metaclass_BSUStatus01):
    """
    Message class 'BSUStatus01'.

    Constants:
      BSU_HL_STOP_REQUEST_FALSE
      BSU_HL_STOP_REQUEST_TRUE
      BSU_ML_STOP_ACTIVATED_LEVEL0
      BSU_ML_STOP_ACTIVATED_LEVEL1
      BSU_ML_STOP_ACTIVATED_LEVEL2
      BSU_ML_STOP_ACTIVATED_LEVEL3
    """

    __slots__ = [
        '_header',
        '_bsu_limp_mode_activated',
        '_bsu_switch_off_req',
    ...
    _fields_and_field_types = {
        ...
        'bsu_limp_mode_activated': 'uint8',
        'bsu_switch_off_req': 'uint8',
    ...
    def __init__(self, **kwargs):
        ...
        self.bsu_limp_mode_activated = kwargs.get('bsu_limp_mode_activated', int())
        self.bsu_switch_off_req = kwargs.get('bsu_switch_off_req', int())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.bsu_limp_mode_activated != other.bsu_limp_mode_activated:
            return False
        if self.bsu_switch_off_req != other.bsu_switch_off_req:
            return False
    ...
    @builtins.property
    def bsu_limp_mode_activated(self):
        """Message field 'bsu_limp_mode_activated'."""
        return self._bsu_limp_mode_activated

    @bsu_limp_mode_activated.setter
    def bsu_limp_mode_activated(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'bsu_limp_mode_activated' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'bsu_limp_mode_activated' field must be an unsigned integer in [0, 255]"
        self._bsu_limp_mode_activated = value

    @builtins.property
    def bsu_switch_off_req(self):
        """Message field 'bsu_switch_off_req'."""
        return self._bsu_switch_off_req

    @bsu_switch_off_req.setter
    def bsu_switch_off_req(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'bsu_switch_off_req' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'bsu_switch_off_req' field must be an unsigned integer in [0, 255]"
        self._bsu_switch_off_req = value
