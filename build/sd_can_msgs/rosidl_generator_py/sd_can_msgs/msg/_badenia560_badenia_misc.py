...
class Metaclass_Badenia560BadeniaMisc(type):
    """Metaclass of message 'Badenia560BadeniaMisc'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.Badenia560BadeniaMisc')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__badenia560_badenia_misc
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__badenia560_badenia_misc
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__badenia560_badenia_misc
            cls._TYPE_SUPPORT = module.type_support_msg__msg__badenia560_badenia_misc
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__badenia560_badenia_misc
...
class Badenia560BadeniaMisc(metaclass=Metaclass_Badenia560BadeniaMisc):
    """Message class 'Badenia560BadeniaMisc'."""
    ...
    def lap_distance(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'lap_distance' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def lap_number(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'lap_number' field must be an unsigned integer in [0, 255]"
