...
class Metaclass_SwVersions01(type):
    """Metaclass of message 'SwVersions01'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.SwVersions01')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sw_versions01
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sw_versions01
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sw_versions01
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sw_versions01
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sw_versions01
...
class SwVersions01(metaclass=Metaclass_SwVersions01):
    """Message class 'SwVersions01'."""
    ...
    __slots__ = [
        ...
        '_pdu12_sw_version',
        '_pdu48_sw_version',
        '_pdu1_sw_version_legacy',
        '_pdu2_sw_version_legacy',
    ]
    ...
    _fields_and_field_types = {
        ...
        'pdu12_sw_version': 'uint8',
        'pdu48_sw_version': 'uint8',
        'pdu1_sw_version_legacy': 'uint8',
        'pdu2_sw_version_legacy': 'uint8',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.pdu12_sw_version = kwargs.get('pdu12_sw_version', int())
        self.pdu48_sw_version = kwargs.get('pdu48_sw_version', int())
        self.pdu1_sw_version_legacy = kwargs.get('pdu1_sw_version_legacy', int())
        self.pdu2_sw_version_legacy = kwargs.get('pdu2_sw_version_legacy', int())
    ...
    def __eq__(self, other):
        ...
        if self.psa_sw_build_version != other.psa_sw_build_version:
            return False
        if self.pdu12_sw_version != other.pdu12_sw_version:
            return False
        if self.pdu48_sw_version != other.pdu48_sw_version:
            return False
        if self.pdu1_sw_version_legacy != other.pdu1_sw_version_legacy:
            return False
        if self.pdu2_sw_version_legacy != other.pdu2_sw_version_legacy:
            return False
        return True
    ...
    @builtins.property
    def pdu12_sw_version(self):
        """Message field 'pdu12_sw_version'."""
        return self._pdu12_sw_version

    @pdu12_sw_version.setter
    def pdu12_sw_version(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu12_sw_version' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu12_sw_version' field must be an unsigned integer in [0, 255]"
        self._pdu12_sw_version = value

    @builtins.property
    def pdu48_sw_version(self):
        """Message field 'pdu48_sw_version'."""
        return self._pdu48_sw_version

    @pdu48_sw_version.setter
    def pdu48_sw_version(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu48_sw_version' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu48_sw_version' field must be an unsigned integer in [0, 255]"
        self._pdu48_sw_version = value

    @builtins.property
    def pdu1_sw_version_legacy(self):
        """Message field 'pdu1_sw_version_legacy'."""
        return self._pdu1_sw_version_legacy

    @pdu1_sw_version_legacy.setter
    def pdu1_sw_version_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu1_sw_version_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu1_sw_version_legacy' field must be an unsigned integer in [0, 255]"
        self._pdu1_sw_version_legacy = value

    @builtins.property
    def pdu2_sw_version_legacy(self):
        """Message field 'pdu2_sw_version_legacy'."""
        return self._pdu2_sw_version_legacy

    @pdu2_sw_version_legacy.setter
    def pdu2_sw_version_legacy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pdu2_sw_version_legacy' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'pdu2_sw_version_legacy' field must be an unsigned integer in [0, 255]"
        self._pdu2_sw_version_legacy = value
