...
class Metaclass_BSUStatus01Updated(type):
    """Metaclass of message 'BSUStatus01Updated'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sd_can_msgs.msg.BSUStatus01Updated')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__bsu_status01_updated
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__bsu_status01_updated
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__bsu_status01_updated
            cls._TYPE_SUPPORT = module.type_support_msg__msg__bsu_status01_updated
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__bsu_status01_updated
    ...
    def BSU_HL_STOP_REQUEST_FALSE(self):
        ...
        return Metaclass_BSUStatus01Updated.__constants['BSU_HL_STOP_REQUEST_FALSE']

    @property
    def BSU_HL_STOP_REQUEST_TRUE(self):
        """Message constant 'BSU_HL_STOP_REQUEST_TRUE'."""
        return Metaclass_BSUStatus01Updated.__constants['BSU_HL_STOP_REQUEST_TRUE']


class BSUStatus01Updated(metaclass=Metaclass_BSUStatus01Updated):
    """
    Message class 'BSUStatus01Updated'.
