...
bool sd_can_msgs__msg__bsu_status01_updated__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._bsu_status01_updated.BSUStatus01Updated", full_classname_dest, 56) == 0);
  }
  sd_can_msgs__msg__BSUStatus01Updated * ros_message = _ros_message;
  {  // header
  ...
  {  // bsu_switch_off_req
    PyObject * field = PyObject_GetAttrString(_pymsg, "bsu_switch_off_req");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bsu_switch_off_req = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bsu_limp_mode_activated
    PyObject * field = PyObject_GetAttrString(_pymsg, "bsu_limp_mode_activated");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bsu_limp_mode_activated = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bsu_hl_stop_request
...
{
  /* NOTE(esteve): Call constructor of BSUStatus01Updated */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._bsu_status01_updated");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BSUStatus01Updated");
  ...
  {  // bsu_switch_off_req
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bsu_switch_off_req);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bsu_switch_off_req", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bsu_limp_mode_activated
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bsu_limp_mode_activated);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bsu_limp_mode_activated", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
