...
bool sd_can_msgs__msg__kistler_vel_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._kistler_vel_angle.KistlerVelAngle", full_classname_dest, 50) == 0);
  }
  sd_can_msgs__msg__KistlerVelAngle * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of KistlerVelAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._kistler_vel_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KistlerVelAngle");
