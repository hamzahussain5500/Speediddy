...
bool sd_can_msgs__msg__diagnostic_word01__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sd_can_msgs.msg._diagnostic_word01.DiagnosticWord01", full_classname_dest, 51) == 0);
  }
  sd_can_msgs__msg__DiagnosticWord01 * ros_message = _ros_message;
  {  // header
  ...
  {  // psa_steer_slip_warning
    PyObject * field = PyObject_GetAttrString(_pymsg, "psa_steer_slip_warning");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->psa_steer_slip_warning = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // ice_error_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "ice_error_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ice_error_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // emb_line_press_over_max_start_limit_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "emb_line_press_over_max_start_limit_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->emb_line_press_over_max_start_limit_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pdu1_counter_error_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "pdu1_counter_error_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->pdu1_counter_error_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pdu1_timeout_error_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "pdu1_timeout_error_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->pdu1_timeout_error_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pdu2_counter_error_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "pdu2_counter_error_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->pdu2_counter_error_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pdu2_timeout_error_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "pdu2_timeout_error_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->pdu2_timeout_error_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // em_piston_hall_not_ready_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "em_piston_hall_not_ready_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->em_piston_hall_not_ready_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // emb_tank_press_under_level1_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "emb_tank_press_under_level1_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->emb_tank_press_under_level1_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // emb_tank_press_under_level2_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "emb_tank_press_under_level2_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->emb_tank_press_under_level2_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // emb_tank_press_under_level3_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "emb_tank_press_under_level3_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->emb_tank_press_under_level3_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // emb_tank_press_under_min_start_limit_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "emb_tank_press_under_min_start_limit_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->emb_tank_press_under_min_start_limit_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // ice_over_rpm_warning_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "ice_over_rpm_warning_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ice_over_rpm_warning_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // ice_diagnostic_spare_legacy
    PyObject * field = PyObject_GetAttrString(_pymsg, "ice_diagnostic_spare_legacy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ice_diagnostic_spare_legacy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of DiagnosticWord01 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sd_can_msgs.msg._diagnostic_word01");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DiagnosticWord01");
  ...
  {  // psa_steer_slip_warning
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->psa_steer_slip_warning);
    {
      int rc = PyObject_SetAttrString(_pymessage, "psa_steer_slip_warning", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ice_error_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->ice_error_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ice_error_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // emb_line_press_over_max_start_limit_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->emb_line_press_over_max_start_limit_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "emb_line_press_over_max_start_limit_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pdu1_counter_error_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pdu1_counter_error_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pdu1_counter_error_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pdu1_timeout_error_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pdu1_timeout_error_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pdu1_timeout_error_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pdu2_counter_error_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pdu2_counter_error_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pdu2_counter_error_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pdu2_timeout_error_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pdu2_timeout_error_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pdu2_timeout_error_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // em_piston_hall_not_ready_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->em_piston_hall_not_ready_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "em_piston_hall_not_ready_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // emb_tank_press_under_level1_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->emb_tank_press_under_level1_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "emb_tank_press_under_level1_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // emb_tank_press_under_level2_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->emb_tank_press_under_level2_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "emb_tank_press_under_level2_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // emb_tank_press_under_level3_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->emb_tank_press_under_level3_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "emb_tank_press_under_level3_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // emb_tank_press_under_min_start_limit_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->emb_tank_press_under_min_start_limit_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "emb_tank_press_under_min_start_limit_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ice_over_rpm_warning_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->ice_over_rpm_warning_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ice_over_rpm_warning_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ice_diagnostic_spare_legacy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->ice_diagnostic_spare_legacy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ice_diagnostic_spare_legacy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
