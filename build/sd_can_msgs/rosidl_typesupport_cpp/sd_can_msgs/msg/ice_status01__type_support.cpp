...
static const _ICEStatus01_type_support_symbol_names_t _ICEStatus01_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sd_can_msgs, msg, ICEStatus01)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sd_can_msgs, msg, ICEStatus01)),
  }
};
...
{
  return &::sd_can_msgs::msg::rosidl_typesupport_cpp::ICEStatus01_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sd_can_msgs, msg, ICEStatus01)() {
  return get_message_type_support_handle<sd_can_msgs::msg::ICEStatus01>();
}
