...
static const _MM710TX2XAX_type_support_symbol_names_t _MM710TX2XAX_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sd_can_msgs, msg, MM710TX2XAX)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sd_can_msgs, msg, MM710TX2XAX)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sd_can_msgs, msg, MM710TX2XAX)() {
  return &::sd_can_msgs::msg::rosidl_typesupport_c::MM710TX2XAX_message_type_support_handle;
}
