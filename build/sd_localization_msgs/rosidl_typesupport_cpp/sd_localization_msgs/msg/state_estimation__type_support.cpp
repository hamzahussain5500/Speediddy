...
static const _StateEstimation_type_support_symbol_names_t _StateEstimation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sd_localization_msgs, msg, StateEstimation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sd_localization_msgs, msg, StateEstimation)),
  }
};
...
{
  return &::sd_localization_msgs::msg::rosidl_typesupport_cpp::StateEstimation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sd_localization_msgs, msg, StateEstimation)() {
  return get_message_type_support_handle<sd_localization_msgs::msg::StateEstimation>();
}
